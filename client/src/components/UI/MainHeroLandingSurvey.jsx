...
export const MainHeroLandingSurvey = () => {
  ...
  return (
    <section className="flex flex-col items-center gap-6 md:flex-row md:justify-between md:gap-2 bg-[#9BC25B]">
      ...
      <section className="flex flex-col md:gap-8 md:flex-row">
