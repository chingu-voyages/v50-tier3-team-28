  ...
  return (
    <section className="flex flex-col pt-6 md:pt-14 md:min-h-[100%]">
      <section className="flex flex-col justify-between gap-4 md:flex-row">
        <section className="bg-[#D8E5C3] rounded-xl md:w-5/12 min-h-full ">
          <section className="px-3 py-6 flex flex-col gap-6 md:py-10 md:justify-stretch md:gap-8 dark:bg-[#3D4D22]">
            <DetailsSummary open
